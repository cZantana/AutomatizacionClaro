...
EXCEL_GENERADO = "intentoListado Claro Postpago Febrero 2025.xlsx" #Nombre del archivo final generado
...
def create_new_excel(file_name):
    ...
    wb = Workbook()
    sheet = wb.active
    sheet.append(["Categoría","Nombre Archivo", "Politíca", "Link de descarga", "Link Conectados", "Vigencia"])  # Encabezados
    wb.save(file_name)
